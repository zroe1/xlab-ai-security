...
Finding targeted adversarial examples that transfer is much harder than finding untargeted examples [@liu2017delvingtransferableadversarialexamples].
This is because the loss landscape for driving the loss up is much eaiser to navigate than
the loss landscape for predicting a singular target class. As a mental model we propose
you think about an indiviudal attempting to climb up a mountain: in the untargeted case
it is easy to climb straight up while in the untargeted case it is unclear which direction to
climb.
...
<div align="center">
  **Fig. 1** <br></br>Targeted vs untargeted loss landscape for image classification security
</div>
...
If you have completed the coding excerises in the previous two sections you will
...
coding excersises where you will complete something more similar to PGD. This involves
less code and no hyperparameters.
