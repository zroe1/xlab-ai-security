...
<ExerciseButtons
  githubUrl="https://github.com/zroe1/xlab-ai-security/blob/main/working/adversarial_basics/ensemble/ensemble.ipynb"
  colabUrl="https://colab.research.google.com/github/zroe1/xlab-ai-security/blob/main/working/adversarial_basics/ensemble/ensemble.ipynb"
/>
...
<p align="center">
  <ThemeImage
    lightSrc="/images/ensemble_light.png"
    darkSrc="/images/ensemble_dark.png"
    alt="Targeted vs untargeted loss landscape"
    style={{ align: "center", width: "40%", display: "block", margin: "0 auto" }}
  />
</p>

<div align="center">
  **Fig. 1** <br></br>Mental model for thinking of targeted vs untargeted attacks
</div>
