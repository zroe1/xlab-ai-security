...
This section has a series of coding problems with Pytorch. For running locally you can follow the
installation instructions at the bottom of this notebook. As always, we <i>highly</i> recommend you read
all the content on this page before starting the coding exercises.

<ExerciseButtons
  githubUrl="https://github.com/zroe1/xlab-ai-security/blob/main/notebooks/robustbench-exercise.ipynb"
  colabUrl="https://colab.research.google.com/github/zroe1/xlab-ai-security/blob/main/notebooks/robustbench-exercise.ipynb"
/>
