...
The authors barrow some methodology from [@wang2023betterdiffusionmodelsimprove] to train their models. We highlight two conceptually important details below, but the authors give a detailed account of all their training setttings in the [original paper]().
