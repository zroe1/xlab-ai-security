...
Once again, we will note that the $L_2$ attack is quite technical and not necessary to understand for future sections of this course. If interested a breif writeup of the attack can be found below with more details in [the paper](https://arxiv.org/pdf/1912.00049) itself.
