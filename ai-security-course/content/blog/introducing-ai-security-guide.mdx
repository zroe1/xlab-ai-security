...
[^1]: Some students may need to learn some machine learning before diving into course content. We describe the prerequisites for the course [here](https://xlabaisecurity.com/getting-started/prerequisites/).
