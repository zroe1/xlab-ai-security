...
What actions are morally permissible and which are objectionable remains, to put it mildly,
a very active debate within the field of moral philosophy.
Rather than taking positions on these ongoing debates,
this document is a compilation of best practices for doing ethical AI security research.
...
which is illegal to release or store, even if it is by accident.
...
become ethically dubious. Except for extremely small models, _we do not recommend you do this_. First, the model itself may be able to cause harm in the
world. It could also be misused to generate harmful data. Before releasing any model,
you should check its level of safety filters and consider different threat models.
...
## 1. Disinterested Ethical Analysis

We believe the best strategy for doing ethical AI security research is "disinterested
...
moral framework to justify anything you would like. Likewise, even without explicitly referencing
any ethical theory, a smart person may be able to come up with reasonable arguments to justify
...
Below we include a more descriptive explanation of the concepts described above.
We will almost never include such a long block quote in this course but the idea here
is so important and well said that we include the original paragraph from the paper in full:
...
## 3. Good Faith Attempts at Defenses
