...
In general, our course requires fairly basic requirements: [PyTorch](https://pytorch.org/), [Matplotlib](https://matplotlib.org/), etc. One less conventional package you will need to install is our own [xlab-security](https://pypi.org/project/xlab-security/) package which you will use for utility functions and running tests.

Please note that if you plan on running our code primarily on Google Colab, you won't have to install anything manually. It is still recommended that you read this document.
