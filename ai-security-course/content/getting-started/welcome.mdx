...
<p align="center">
  <img
    ...
    style={{ align: "center", width: "75%", display: "block", margin: "0 auto" }}
  />
</p>
...
University of Chicago’s Existential Risk Labrotory (XLab) to give researchers
