...
```
without requiring refusal in later tokens (in fact, that would be quite unintuitive; after all, humans usually don't refuse and then comply immediately after). 
