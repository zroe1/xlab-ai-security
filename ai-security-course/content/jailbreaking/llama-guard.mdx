...
1. A set of guidelines: each task (passed as a prompt) given to Llama Guard also contains a set of guidelines that the model follows when classifying the content. It _only_ follows these guidelines.
