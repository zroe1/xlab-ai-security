...
Perhaps the most intersting finding from [@anil2024manyshot] is that the in-context
...
that the effectiveness of MSJ increases with the number of incontext examples for a variety of different model sizes.
...
<div align="center">
  **Fig. 1** <br></br> Attack success rate and NLL of harmful response as a function of number of incontext
