...
<ExerciseButtons
  githubUrl="https://github.com/zroe1/xlab-ai-security/blob/main/working/jailbreaking/pair_tap/pair_tap.ipynb"
  colabUrl="https://colab.research.google.com/github/zroe1/xlab-ai-security/blob/main/working/jailbreaking/pair_tap/pair_tap.ipynb"
/>
...
\hline
\text{\bf Input: } \text{Attack Objective } O, \text{ branching factor } b, \\
\, \quad \quad \quad \text{ max width } w, \text{ max depth } d \\
\text{\bf Initialize: } \text{root with empty conversation history and attack objective } O \\[0.375em]
...
\quad \quad \text{Add } b \text{ children of } \ell \text{ w/ prompts }P_1, \ ..., \ P_b \text{ and conversations } C_\ell \\
\quad \text{\bf for } \text{each leaf } \ell \text{ \bf do } \\
