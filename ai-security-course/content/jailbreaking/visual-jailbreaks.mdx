...
Formally, given a corpus of harmful text $Y = \{ y_i \}_{i = 1}^m$, we create the adversarial examples by maximizing the probability of generating this corpus given our adversarial image:
$$
