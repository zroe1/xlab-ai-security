...
<OrganizationCard
  name="MATS"
  description="The ML Alignment & Theory Scholars (MATS) Program is an in person fellowhsip opportunity where mentees work with mentors to develop AI safety and security research."
...
<OrganizationCard
  ...
  description="The Center for AI Safety (CAIS) does research, feild building and provides compute for AI safety researchers."
...
<OrganizationCard
  name="Constellation"
  description="Constellation is a physical location in Berkly. They have a visting fellows program and other opportunities you can apply to."
