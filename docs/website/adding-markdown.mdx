...
2.  Once you have done that you will need to edit the navigation object located in `ai-security-course/src/data/navigation.ts`. Below is an example of what part of the navigation object may look like.
